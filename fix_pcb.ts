...
const actionsBlockRegex = /<div class="form-actions"\s*>\s*<button type="reset" id="resetBtn" class="btn btn-outline">\s*Reset\s*<\/button>\s*<button type="submit" class="btn btn-primary" id="calculatePcbBtn"[^>]*>\s*Calculate\s*<\/button>\s*<\/div>/g;
